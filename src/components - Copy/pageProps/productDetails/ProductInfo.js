...
const ProductInfo = ({ productInfo }) => {
  ...
  return (
    <div className="flex flex-col gap-5">
      <h2 className="text-4xl font-semibold">Scientific Calculator</h2>
      <p className="text-2xl font-semibold">
        800 rupees
        <span className="text-xl font-semibold line-through ml-2">1200</span>
        <span className="text-xs ml-2 inline-flex items-center px-3 py-1 rounded-full bg-green-600 text-white">
          Save 500
        </span>
      </p>
      <hr />
      <p className="text-base text-gray-600">Get high-performance calculations with our pre-owned scientific calculator, featuring essential functions for advanced math and science. Thoroughly tested for reliability and accuracy, it offers great value at a fraction of the new price.</p>
      ...
      <p className="font-normal text-sm">
        ...
        Scientific Calculator for college student
      </p>
    </div>
  );
};
